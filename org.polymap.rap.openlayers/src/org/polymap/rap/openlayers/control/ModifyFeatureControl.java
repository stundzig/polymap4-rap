...
//                + "        this.layer.drawFeature( this.feature, this.standalone ? undefined : 'select' );"
                ...
                // everything above does not seem to work; just refreshing the layer
                // is overhead but does what I expect here
                + "        this.layer.refresh();"
                + "        handled = true;"
                + "        break;"
                + "    }"
	...
	public void addMode(int mode) {
		super.execute("obj.mode |= OpenLayers.Control.ModifyFeature." + mode2name(mode));
	}
