...
import org.polymap.rap.openlayers.features.VectorFeature;
...
public class SelectFeatureControl extends Control {
    ...
    public void setHover( boolean hover ) {
        ...
        super.setAttribute( "hover", hover );
    }
	...
	public void setMultipleKey(String key) {
		super.setAttribute("multipleKey", key);
	}
	...
	public void setToggleKey(String key) {
		super.setAttribute("toggleKey", key);
	}
	...
	public void setMultiple(boolean multiple) {
		super.setAttribute("multiple", multiple);
	}

	public void setRenderIntent(String intent) {
		super.setAttribute("renderIntent", intent);
	}
	...
	public void setHighlightOnly(Boolean highlight_only) {
		super.setAttribute("highlightOnly", highlight_only);
	}
	
    public void selectFeatures(Collection<VectorFeature> features) {
        for (VectorFeature feature : features) {
            super.execute( "select", feature );
        }
    }

    public void selectFids(Collection<String> fids) {
        for (String fid : fids) {
            super.execute( "var layer = " + layer.getJSObjRef() + ";" +
    ...
    public void unselectAll() {
        execute( getJSObjRef() + ".unselectAll();" );
    }
