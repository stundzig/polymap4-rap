...
//                payload_code.add( "'event_payload_", entry.getKey() + "' : " + entry.getValue() + "," );
//            }
//        }
//
//		obj.addObjModCode( new Stringer( "this.obj.events.register('", event_name, "', this, function( event ) {",
//                "console.log( 'event:' + event );",
//                    "rap.getRemoteObject(this).call('handle" + event_name + "', {",
//                    	"'event_name' : event.type,",
//                        payload_code,                    	
//                    	"'event_src_obj' : '" + obj.getObjRef() + "'",
//                    "});", 
//                "});" ).toString() );
//    }
//
