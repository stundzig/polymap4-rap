...
public class DemoEntryPoint extends AbstractEntryPoint {
    ...
    private static DemoTab[] createExampleTabs() {
        return new DemoTab[] { new ClickControlTab(), new DrawInteractionTab(), new ExtentTab(), new FeatureVectorTab(),
                new GraphInteractionTab(), new ResolutionsTab(), new SelectInteractionTab(), new ScaleLineControlTab(),
